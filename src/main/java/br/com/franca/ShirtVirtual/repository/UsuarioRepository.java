...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    ...
    @Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO usuarios_acesso (usuario_id, acesso_id) VALUES (?1,(SELECT id FROM acesso WHERE descricao_acesso='ROLE_ADMIN'))")
    void cadastroAcessoUserPJ(Long id);
